...
if ( ! empty( $widget_content_css ) ) {
	$widget_content_dynamic_css = '.cwp-top-footer .widget, .cwp-top-footer .widget a:not([class*="gutentor-"]){
		' . $widget_content_css . '
	}';
...
if ( ! empty( $widget_content_tablet_css ) ) {
	$widget_content_dynamic_tablet_css = '.cwp-top-footer .widget, .cwp-top-footer .widget a:not([class*="gutentor-"]){
		' . $widget_content_tablet_css . '
	}';
...
if ( ! empty( $widget_content_desktop_css ) ) {
	$widget_content_dynamic_desktop_css = '.cwp-top-footer .widget, .cwp-top-footer .widget a:not([class*="gutentor-"]){
		' . $widget_content_desktop_css . '
	}';
...
/*Mobile css*/
if ( ! empty( $widget_content_css ) ) {
	$widget_content_dynamic_css = '.cwp-main-footer .widget, .cwp-main-footer .widget a:not([class*="gutentor-"]){
		' . $widget_content_css . '
	}';
	$footer_dynamic_css['all'] .= $widget_content_dynamic_css;
}
...
/*Tablet css*/
if ( ! empty( $widget_content_tablet_css ) ) {
	$widget_content_dynamic_tablet_css = '.cwp-main-footer .widget, .cwp-main-footer .widget a:not([class*="gutentor-"]){
		' . $widget_content_tablet_css . '
	}';
	$footer_dynamic_css['tablet']     .= $widget_content_dynamic_tablet_css;
}
...
/*Desktop css*/
if ( ! empty( $widget_content_desktop_css ) ) {
	$widget_content_dynamic_desktop_css = '.cwp-main-footer .widget, .cwp-main-footer .widget a:not([class*="gutentor-"]){
		' . $widget_content_desktop_css . '
	}';
	$footer_dynamic_css['desktop']     .= $widget_content_dynamic_desktop_css;
}
...
/*mobile css*/
if ( ! empty( $widget_content_css ) ) {
	$widget_content_dynamic_css = '.cwp-bottom-footer .widget, .cwp-bottom-footer .widget a:not([class*="gutentor-"]){
		' . $widget_content_css . '
	}';
	$footer_dynamic_css['all'] .= $widget_content_dynamic_css;
}
...
/*tablet css*/
if ( ! empty( $widget_content_tablet_css ) ) {
	$widget_content_dynamic_tablet_css = '.cwp-bottom-footer .widget, .cwp-bottom-footer .widget a:not([class*="gutentor-"]){
		' . $widget_content_tablet_css . '
	}';
	$footer_dynamic_css['tablet']     .= $widget_content_dynamic_tablet_css;
}
...
/*desktop css*/
if ( ! empty( $widget_content_desktop_css ) ) {
	$widget_content_dynamic_desktop_css = '.cwp-bottom-footer .widget, .cwp-bottom-footer .widget a:not([class*="gutentor-"]){
		' . $widget_content_desktop_css . '
	}';
	$footer_dynamic_css['desktop']     .= $widget_content_dynamic_desktop_css;
}
