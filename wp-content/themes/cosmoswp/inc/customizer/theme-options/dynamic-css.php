...
if ( ! empty( $cosmoswp_widget_link_css ) ) {
	$widget_link_dynamic_css          = '.cwp-sidebar .widget a:not([class*="gutentor-"]), .cwp-sidebar .widget article:not([class*="gutentor-"]) *a, .cwp-sidebar .widget li a:not([class*="gutentor-"]){
