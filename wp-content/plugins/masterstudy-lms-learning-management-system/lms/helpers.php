...
function stm_lms_available_addons()
{
    return array(
        ...
        'certificate_builder' => array(
            ...
            'pro_url' => 'https://stylemixthemes.com/wordpress-lms-plugin/?utm_source=wpadmin&utm_medium=ms-certificatebuilder&utm_campaign=masterstudy-plugin&licenses=5&billing_cycle=annual'
        ),
        'form_builder' => array(
            'name' => esc_html__('LMS Forms Editor', 'masterstudy-lms-learning-management-system'),
            'url' => esc_url(STM_LMS_URL . '/assets/addons/custom_fields.jpg'),
